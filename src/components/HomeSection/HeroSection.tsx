      ...
      <div className="max-w-7xl mx-auto ">
        <div className="flex h-[94vh] justify-around items-center gap-4">
          <div className="space-y-3">
            ...
            <h1 className="text-3xl font-bold">I'm a Full-Stack Developer</h1>

            <div className="flex justify-start items-center gap-4 pt-4">
              <button className="border px-4 py-4  rounded-full"><FaFacebook /></button>
              <button className="border px-4 py-4 rounded-full"><GrLinkedin /></button>
              <button className="border px-4 py-4 rounded-full"><FaGithub /></button>
            </div>
            <div className="pt-4">
