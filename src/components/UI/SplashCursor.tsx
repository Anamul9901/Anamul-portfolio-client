...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Respect reduced-motion + skip on touch-only devices (no mouse to trail).
    ...
    // --- Pointer handlers (named so cleanup can remove them) ---
    ...
    // --- Cleanup: cancel the RAF loop + remove every listener (prevents leaks) ---
    return () => {
